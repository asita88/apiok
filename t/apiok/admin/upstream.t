...
location /t {
    content_by_lua_block {
        ...
        local code, message, body = t("/apiok/admin/upstreams", ngx.HTTP_POST, {
...
location /t {
    content_by_lua_block {
        ...
        local code, message, body = t("/apiok/admin/upstream/nodes", ngx.HTTP_POST, {
            name = "test-nginx-upstream-node-created",
            address = "127.0.0.1",
            port = 8888,
            check = {}
...
location /t {
    content_by_lua_block {
        ...
        local code, message, body = t("/apiok/admin/upstreams/test-nginx-upstream-created", ngx.HTTP_PUT, {
            name = "test-nginx-upstream-created",
            algorithm = "round-robin",
...
location /t {
    content_by_lua_block {
        ...
        local code, message, body = t("/apiok/admin/upstreams", ngx.HTTP_GET)
...
location /t {
    content_by_lua_block {
        ...
        local code, message, body = t("/apiok/admin/upstreams/test-nginx-upstream-created", ngx.HTTP_GET)
...
location /t {
    content_by_lua_block {
        ...
        local code, message, body = t("/apiok/admin/upstreams/test-nginx-upstream-created", ngx.HTTP_DELETE)

        ngx.status = code
        ngx.say(message)

        local code, message, body = t("/apiok/admin/upstream/nodes/test-nginx-upstream-node-created", ngx.HTTP_DELETE)
