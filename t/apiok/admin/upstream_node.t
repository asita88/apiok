...
location /t {
    content_by_lua_block {
        ...
        local code, message, body = t("/apiok/admin/upstream/nodes/test-nginx-upstream-node-created", ngx.HTTP_PUT, {
            name = "test-nginx-upstream-node-created",
            address = "127.0.0.1",
            port = 8888,
            health = "UNHEALTH",
...
location /t {
    content_by_lua_block {
        ...
        local code, message, body = t("/apiok/admin/upstream/nodes", ngx.HTTP_GET)
...
location /t {
    content_by_lua_block {
        ...
        local code, message, body = t("/apiok/admin/upstream/nodes/test-nginx-upstream-node-created", ngx.HTTP_GET)
