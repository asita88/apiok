...
location /t {
    content_by_lua_block {
        ...
        local code, message = t('/apiok/admin/service/1001', ngx.HTTP_PUT, {
            name = "test service",
            prefix = "/demo01",
...
location /t {
    content_by_lua_block {
        ...
        request_header["APIOK-SERVICE-ID"] = 1001
        local code, message = t('/apiok/admin/router/100101', ngx.HTTP_PUT, {
...
location /t {
    content_by_lua_block {
        local t = require("tools.request").test
        local code, message = t('/apiok/admin/service/1001/plugin', ngx.HTTP_POST, {
            key = "key-auth",
            config = {
...
location /t {
    content_by_lua_block {
        local t = require("tools.request").test
        local code, message = t('/apiok/admin/service/1002', ngx.HTTP_PUT, {
            name = "test service",
            prefix = "/demo02",
            desc = "this is a test project",
            upstreams = {
...
location /t {
    content_by_lua_block {
        local t = require("tools.request").test
        local request_header = {}
        request_header["APIOK-SERVICE-ID"] = 1002
        local code, message = t('/apiok/admin/router/100201', ngx.HTTP_PUT, {
            name = "test service plugin",
            path = "/router/plugin",
            method = "GET",
            enable_cors = true,
...
location /t {
    content_by_lua_block {
        ...
        local request_header = {}
        request_header["APIOK-SERVICE-ID"] = 1002
        local code, message = t('/apiok/admin/router/100201/plugin', ngx.HTTP_POST, {
            key = "key-auth",
            config = {
